...
public class GraniteAssistantEngine {
    ...
    public Capability classify(String command) {
        ...
        String output = completion.choices().getFirst().message().content().orElseThrow(() -> new IllegalStateException("Granite returned no content")).trim();
        return Capability.fromValue(output);
    }
}
